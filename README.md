...
and uses Cursor, Claude Code and embedded apps with nvidia GPUs.

**others**

![Other skills](https://skillicons.dev/icons?i=raspberrypi,docker,kotlin,webpack,cpp,aws,azure,next,vercel,tailwind,emotion,vscode,go,mysql)
